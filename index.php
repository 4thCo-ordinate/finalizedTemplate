...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
    <!-- This is code for the search bar write the script name for search action -->
  ...
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li class="usrstyle"><a class="drop" href="#">Staff</a>
          <ul>
            <li><a href="#">Academic Heads</a></li>
            <li><a href="#">Techers</a></li>
            <li><a href="#">Commitee</a></li>
          </ul>
        </li>
        <li class="usrstyle"><a class="drop" href="curriculum/index.php">Curriculum</a>
          <ul>
            <li><a href="curriculum/#">National Festivals</a></li>
            <li><a href="curriculum/#">Anual Days</a></li>
            <li><a href="curriculum/#">Co-curricular Activities</a></li>
          </ul>
        </li>
        <li class="usrstyle"><a href="#">Calendar</a></li>
        <li class="usrstyle"><a href="#">Contact Us</a></li>
      </ul>
      <!-- ################################################################################################ --> 
    </nav>
  </div>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1" class="mySlides"><a class="view" href="#"><img src="images/demo/slider/1.png" alt=""></a>
        <figcaption>
          <h2>First Image </h2>
      ...
      <figure id="slide-2" class="mySlides"><a class="view" href="#"><img src="images/demo/slider/2.png" alt=""></a>
        <figcaption>
          <h2>Second Image</h2>
      ...
      <figure id="slide-3" class="mySlides"><a class="view" href="#"><img src="images/demo/slider/3.png" alt=""></a>
        <figcaption>
          <h2>Image 3 </h2>
          <p>Description about third image.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
        </figcaption>
      </figure>
      <figure id="slide-4" class="mySlides"><a class="view" href="#"><img src="images/demo/slider/4.png" alt=""></a>
        <figcaption>
          <h2>Image 4 </h2>
          <p>Description about fourth image.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
        </figcaption>
      </figure>
      <figure id="slide-5" class="mySlides"><a class="view" href="#"><img src="images/demo/slider/5.png" alt=""></a>
        <figcaption>
          <h2>Image 5 </h2>
          <p>Description about fifth image.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
        </figcaption>
      </figure>
      <!-- ################################################################################################ -->
      <ul id="slide-tabs">
        <li><a onclick="showDivs(6)" href="#slide-1">All About The University</a></li>
        <li><a onclick="showDivs(7)" href="#slide-2">Why You Should Study With Us</a></li>
        <li><a onclick="showDivs(8)" href="#slide-3">Education And Student Experience</a></li>
        <li><a onclick="showDivs(9)" href="#slide-4">Alumni And Its Donors</a></li>
        <li><a onclick="showDivs(0)" href="#slide-5">Latest University News &amp; Events</a></li>
      </ul>
      <!-- ################################################################################################ --> 
    </div>
  </div>
